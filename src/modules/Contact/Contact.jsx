...
function Contact() {
  return (
    ...
    <div className="xl:mx-auto px-[1.5rem] md:px-[3rem] lg:px-[6rem] max-w-[1280px] xl:max-w-[1440px] xxl:max-w-[1600px] py-20 lg:py-40 ">
      <div className="relative w-full flex lg:flex-row flex-col items-center justify-between  ">
        <h3 className="py-10 lg:py-20 text-[2.5rem] md:text-[3rem] lg:text-[4rem] font-mont font-bold leading-snug xl:w-[80%]">
